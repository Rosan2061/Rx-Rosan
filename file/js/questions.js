const questions = [
  ...
  {
    question: "21.<br>가: 지금 몇 시 입니까?<br>나: ....있어요.",
    options: { a: "일 시 삼 분", b: "한 시 세 분", c: "한 시 삼 분", d: "일 시 세 분" },
    answer: "c",
    explanation: "Review not Aviable."
  },
  {
    question: "22.<br>  이 사진은 뭐의 입니까?",
    options: { a: "신발장 입니다.", b: "옷장 입니다.", c: "식탁 입니다.", d: "주스 입니다." },
    answer: "b",
    explanation: "Review not Aviable.",
    image: "file/img/img7.jpg"
  },
  {
    question: "23.<br> 저는 밥... 먹습니다.",
    options: { a: "을", b: "븐", c: "은", d: "블" },
    answer: "a",
    explanation: "Review not Aviable."
  },
  {
    question: "24.<br>  이 사진은 뭐의 입니까?",
    options: { a: "보도", b: "밥", c: "사과", d: "술" },
    answer: "c",
    explanation: "Review not Aviable.",
    image: "file/img/img16.jpg"
  },
  {
    question: "25.<br>  이 사진은 뭐의 입니까?",
    options: { a: "버스 입니다.", b: "차 입니다.", c: "의자 입니다.", d: "짐대 입니다." },
    answer: "c",
    explanation: "Review not Aviable.",
    image: "file/img/img8.jpg"
  },
  {
    question: "26.<br>  이 사진은 뭐의 입니까?",
    options: { a: "나라", b: "집", c: "지도", d: "도시" },
    answer: "c",
    explanation: "Review not Aviable.",
    image: "file/img/img17.jpg"
  },
  {
    question: "27.<br>  이 사진은 뭐의 입니까?",
    options: { a: "구두가 세 켤레 있습니다.", b: "구두가 다섯 켤레 있습니다.", c: "구두가 네 켤레 있습니다.", d: "구두가 여섯 켤레 있습니다." },
    answer: "c",
    explanation: "Review not Aviable.",
    image: "file/img/img18.jpg"
  },
  {
    question: "28.<br>  이 사진은 뭐의 입니까?",
    options: { a: "기차 입니다.", b: "택시 입니다.", c: "버스 입니다.", d: "자동차 입니다." },
    answer: "d",
    explanation: "Review not Aviable.",
    image: "file/img/img9.jpg"
  },
  {
    question: "29.<br>  이 사진은 뭐의 입니까?",
    options: { a: "가방 입니다.", b: "차 입니다.", c: "공책 입니다.", d: "짐대 입니다." },
    answer: "c",
    explanation: "Review not Aviable.",
    image: "file/img/img19.jpg"
  },
  {
    question: "30.<br>  이 사진은 뭐의 입니까?",
    options: { a: "여섯 사람이 회의를 하고 있습니다.", b: "다섯 사람이 회의를 하고 있습니다.", c: "네 사람이 회의를 하고 있습니다.", d: "세 사람이 회의를 하고 있습니다." },
    answer: "c",
    explanation: "Review not Aviable.",
    image: "file/img/img20.jpg"
  },
  {
    question: "31.<br>  이 사진은 뭐의 입니까?",
    options: { a: "자전거 입니다.", b: "택시 입니다.", c: "버스 입니다.", d: "지하천 입니다." },
    answer: "a",
    explanation: "Review not Aviable.",
    image: "file/img/img10.jpg"
  },
  {
    question: "32.<br>  이 사진은 뭐의 입니까?",
    options: { a: "집 입니다.", b: "공원 입니다.", c: "회사 입니다.", d: "하교 입니다." },
    answer: "a",
    explanation: "Review not Aviable.",
    image: "file/img/img22.jpg"
  },
  {
    question: "33.<br>  이 사진은 뭐의 입니까?",
    options: { a: "라디오", b: "택시", c: "버스", d: "나라" },
    answer: "a",
    explanation: "Review not Aviable.",
    image: "file/img/img23.jpg"
  },
  {
    question: "34.<br>  이 사진은 뭐의 입니까?",
    options: { a: "비행기 입니다.", b: "기차 입니다.", c: "트레그 입니다.", d: "유교 입니다." },
    answer: "b",
    explanation: "Review not Aviable.",
    image: "file/img/img11.jpg"
  },
  {
    question: "35.<br> 길로미터",
